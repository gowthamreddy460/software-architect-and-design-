...
3. open the programming tool and select the project folder in the tool.

4. create another folder to run the home page to pass the message in the homepage.

5. Run the homepage to see the message.
